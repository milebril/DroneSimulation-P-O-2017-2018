...
public class Camera {
	...
	public BufferedImage takeSnapshot() {
		...
		GL11.glReadPixels(0, 0, snapshotWidth, snapshotHeight, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, buffer); // Only
																												// take
																												// camera
																												// view
	...
	/**
	 * a method like takeSnapshot() that takes a snapshot but returns it as a byte
	 * array
	 */
